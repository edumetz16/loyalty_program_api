...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LoyaltyProgramApi.Respuesta();
  });
  ...
  describe('Respuesta', function() {
    it('should create an instance of Respuesta', function() {
      // uncomment below and update the code to test Respuesta
      //var instane = new LoyaltyProgramApi.Respuesta();
      //expect(instance).to.be.a(LoyaltyProgramApi.Respuesta);
    });
