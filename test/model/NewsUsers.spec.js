...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LoyaltyProgramApi.NewsUsers();
  });
  ...
  describe('NewsUsers', function() {
    it('should create an instance of NewsUsers', function() {
      // uncomment below and update the code to test NewsUsers
      //var instane = new LoyaltyProgramApi.NewsUsers();
      //expect(instance).to.be.a(LoyaltyProgramApi.NewsUsers);
    });
