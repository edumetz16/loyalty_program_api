...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LoyaltyProgramApi.City();
  });
  ...
  describe('City', function() {
    it('should create an instance of City', function() {
      ...
      //var instane = new LoyaltyProgramApi.City();
      //expect(instance).to.be.a(LoyaltyProgramApi.City);
    });

    it('should have the property idLocalidad (base name: "idLocalidad")', function() {
      // uncomment below and update the code to test the property idLocalidad
      //var instane = new LoyaltyProgramApi.City();
