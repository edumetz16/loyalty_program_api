...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LoyaltyProgramApi.ClubUserRequest();
  });
  ...
  describe('ClubUserRequest', function() {
    it('should create an instance of ClubUserRequest', function() {
      // uncomment below and update the code to test ClubUserRequest
      //var instane = new LoyaltyProgramApi.ClubUserRequest();
      //expect(instance).to.be.a(LoyaltyProgramApi.ClubUserRequest);
    });
