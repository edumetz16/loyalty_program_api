...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LoyaltyProgramApi.ContactResponse();
  });
  ...
  describe('ContactResponse', function() {
    it('should create an instance of ContactResponse', function() {
      ...
      //var instane = new LoyaltyProgramApi.ContactResponse();
      //expect(instance).to.be.a(LoyaltyProgramApi.ContactResponse);
    });

    it('should have the property respuesta (base name: "Respuesta")', function() {
      // uncomment below and update the code to test the property respuesta
      //var instane = new LoyaltyProgramApi.ContactResponse();
